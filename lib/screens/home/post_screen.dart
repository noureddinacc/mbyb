    ...
    return InputDecoration(
      ...
      focusedBorder: OutlineInputBorder(
        ...
        borderSide: BorderSide(
          color: isDark ? Colors.teal[700]! : Colors.blue[300]!,
          width: 1.5,
        ),
      ),
                  ...
                  Row(
                    children: [
                      ...
                      _buildTypeSelector(
                        'exchange',
                        'تبادل',
                        isDark ? Colors.blue[900]! : Colors.blue[600]!,
                      ),
                      _buildTypeSelector(
                        'request',
                        'مطلوب',
                        isDark ? Colors.purple[900]! : Colors.purple[600]!,
                      ),
                    ],
                  ),
